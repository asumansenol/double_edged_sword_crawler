     ...
     */
    function checkElementVisibilityForFathom(fnodeOrElement) {
    ...
    var utilsForFrontend = /*#__PURE__*/Object.freeze({
        ...
        ancestors: ancestors,
        sigmoid: sigmoid,
        checkElementVisibilityForFathom: checkElementVisibilityForFathom,
    ...
    class Lhs {
         ...
         *
         * Example: ``dom('p').when(checkElementVisibilityForFathom)``
         *
